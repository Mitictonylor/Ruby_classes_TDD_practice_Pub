...
class PubTest < MiniTest::Test
  def setup
    ...
    @customer4 = Customer.new("Francis", 10.00, 25, 31)
  end
...
def test_customer_too_drunk__returns_true
  assert_equal(true, @pub.customer_too_drunk(@customer4))
end

def test_sell_drink_to_customer_not_possible_because_drunk()
  @pub.sell_drink_to_customer(@customer4,@drink3)
  assert_equal(10.00, @customer4.wallet())
  assert_equal(100.00, @pub.till())
  assert_equal(31, @customer4.drunkenness())
end

def test_sell_drink_to_customer_not_possible_because_too_young()
  @pub.sell_drink_to_customer(@customer2,@drink3)
